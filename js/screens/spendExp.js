	...
	onResetEvent: function() {	
		...
		me.game.world.addChild(new (me.Renderable.extend({
			...
			draw: function(renderer) {
				...
				this.fond.draw(renderer.detContext(), "F1: INCREASE GOLD PRODUCTION CURRENT LEVEL: " + game.data.exp1.toString() + " COST: " + ((game.data.exp1 + 1 * 10)), this.pos.x , this.pos.y + 100);
